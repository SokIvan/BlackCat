...
class SupabaseStorage:
    ...
    def __init__(self):
        ...
        try:
            # ПРАВИЛЬНАЯ инициализация для версии 2.20.0
    ...
    def register_user(self, user_id: int, computer_id: str, username: str = None, first_name: str = None) -> bool:
        ...
        try:
            ...
            self.logger.error(f"❌ API ошибка регистрации пользователя: {e}")
            return False
        except Exception as e:
    ...
    def get_stats(self) -> Dict:
        ...
        try:
            ...
            alerts_response = self.client.table('alerts')\
                .select('id', count='exact')\
                .execute()
            
            return {
                "total_users": users_response.count or 0,
                "total_computers": users_response.count or 0,  # Один пользователь = один компьютер
